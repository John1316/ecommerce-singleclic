        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
            <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                <a href="#" className="shrink-0 md:order-1">
                    ...
                    <img className="hidden h-20 w-20 dark:block" src={product?.image || ''} alt="imac image" />
                </a>
                ...
                <div className="flex items-center justify-between md:order-3 md:justify-end">
                    ...
                    <div className="text-end md:order-4 md:w-32">
                        <p className="text-base font-bold text-gray-900 dark:text-white">{(product?.quantity || 0) * product.price} LE</p>
                    </div>
                </div>
                ...
                <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button onClick={()=> removeFromCart(product.id || 0)} type="button" className="inline-flex items-center text-sm font-medium text-red-600 hover:underline dark:text-red-500">
