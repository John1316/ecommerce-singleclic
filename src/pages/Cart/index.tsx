                ...
                <div className="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
                    <div className="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
                        <div className="space-y-6">
                            ...
                            {visibility && <div className="flex items-center p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
                                <CartIcon />
                                <span className="sr-only">Info</span>
                                <div>
                                    <span className="font-medium">Order Successfully Placed! 🎉</span> Thank you for your purchase. Your order confirmed
                                </div>
                            </div>}
                        </div>
