                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <dl className="flex items-center justify-between gap-4">
                                        ...
                                        <dd className="text-base font-medium text-gray-900 dark:text-white">{state.total.toFixed(1) || 0}</dd>
                                    </dl>
                                    ...
                                    <dl className="flex items-center justify-between gap-4">
                                        ...
                                        <dd className="text-base font-medium text-gray-900 dark:text-white">{(state.total * 0.14).toFixed(1)}</dd>
                                    </dl>
                                </div>
